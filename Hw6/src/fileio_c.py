...
def uniform_quantize(inFile_path):
...
def floatPoint_quantize(inFile_path):
    # create the audio file objects of the appropriate audioFile type
    inFile = PCMFile(inFile_path)
    # open input file and get its coding parameters
    codingParams = inFile.OpenForReading()
...
def blockFloatPoint_quantize(inFile_path):
    # create the audio file objects of the appropriate audioFile type
    inFile = PCMFile(inFile_path)
    # open input file and get its coding parameters
    codingParams = inFile.OpenForReading()
...
if __name__ == "__main__":
    ...
    floatPoint_quantize("../audio/harpsichord.wav")
    blockFloatPoint_quantize("../audio/harpsichord.wav")
